...
// Valid returns true if the errors map doesn't contain entries.
...
// PermittedValue Generic function which returns true if a specific value is in a list of permitted values.
